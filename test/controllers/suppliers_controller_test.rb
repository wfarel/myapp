...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { image: @supplier.image, industria: @supplier.industria, nombre: @supplier.nombre } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { image: @supplier.image, industria: @supplier.industria, nombre: @supplier.nombre } }
